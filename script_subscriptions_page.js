...
function showMySubscriptions(){
    ...
    for(var i = 0; i < dataObj.Services.Mobile_Services.PostPaid.length; i++){
        document.querySelector(".post-paid-plans").innerHTML += "<p>" + dataObj.Services.Mobile_Services.PostPaid[i].Name + "<\p>" +
        ...
        "<div class=\"unsubscribe__btn\"> <button class=\"unsubscribe__btn--right\" onClick=\"unsubscribe()\">Unsubscribe</button><hr></div>";
    }
    ...
    for(var i = 0; i < dataObj.Services.TV_Wireless_Services.Home_Internet.length; i++){
        document.querySelector(".home-internet").innerHTML += "<p>" + dataObj.Services.TV_Wireless_Services.Home_Internet[i].Name + "<\p>" +
    ...
    for(var i = 0; i < dataObj.Services.TV_Wireless_Services.TV_Packages.length; i++){
        document.querySelector(".tv-packages").innerHTML += "<p>" + dataObj.Services.TV_Wireless_Services.Home_Internet[i].Name + "<\p>" +
